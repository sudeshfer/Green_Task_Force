...
VALUES (NULL, '$newFirstName', '$newLastName', '$newusername', '$newpassword', '$newemail', 'staff')";

if ($conn->query($sql) === TRUE) {

  $sqlinsert2 = "INSERT INTO activities (id, description, uploaded_date) 
  VALUES (NULL, ' <b><i>$get_captain_name</i></b> (Captain) Created a <i>Staff</i> Account as <b><i>$newusername</i></b>', CURRENT_TIMESTAMP)";
...
<button class="open-button" onclick="openForm()">Add a staff member</button>
</div>
</center>
</center>
