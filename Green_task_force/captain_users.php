...
if (isset($_POST['remove_user']))
{
  ...
  else
  {
    ...
    if ($conn->query($sql) === TRUE) {
                ...
                VALUES (NULL, '<b><i>$get_captain_name</i></b> (Captain)  Removed  <b><i>$user</i></b> (User)', CURRENT_TIMESTAMP)";
...
if (isset($_POST['remove_staff']))
{
  ...
  else
  {
    ...
    if ($conn->query($sql) === TRUE) {
                ...
                $sqlinsert2 = "INSERT INTO activities (id, description, uploaded_date) 
                VALUES (NULL, '<b><i>$get_captain_name</i></b> (Captain)  Removed  <b><i>$user</i></b> (Staff member)', CURRENT_TIMESTAMP)";
